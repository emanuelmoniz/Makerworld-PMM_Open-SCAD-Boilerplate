@echo off
REM ============================================================
REM <PROJECT NAME>  |  Run PMM lint + smoke checks
REM Double-click, or run from a terminal. Optional first argument: a project
REM folder, e.g.  check.bat examples\demo   (default: this repo's root project).
...
"%BASH_EXE%" "%~dp0check/check.sh" %PROJECT_ARG%
if errorlevel 1 (
    echo.
