...
| Config | Controls |
|---|---|
| `project_config.sh` | identity, `SOURCE_FILES`, plate file, libraries, colors, README markers, dev views |
...
`shared/` (Python helpers, tool discovery). Also `init_project.py` (fill template tokens).
