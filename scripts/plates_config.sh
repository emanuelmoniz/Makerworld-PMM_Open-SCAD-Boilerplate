# ============================================================
# <PROJECT NAME>  |  Plates configuration (shared by 2 pipelines)
# ------------------------------------------------------------
...
# Section 3 (ASSEMBLY_PLATE_VIEWS) drives MakerWorld's assembly view AND the
# 3mf export's non-printing preview plate.
#
