# ============================================================
# Sliding-Lid Box (demo)  |  Project configuration
# ------------------------------------------------------------
...
PROJECT_NAME="Sliding-Lid Box (demo)"
PROJECT_SLUG="sliding_lid_box"
...
BUNDLED_LIBRARIES=(
    # none -- this demo uses no external library
)
...
COLOR_PASSTHROUGH=(
    "label_color"    # user-facing // color parameter: must stay distinct
)
...
DEV_VIEWS=(
    "assembly_main:Assembly (lid closed)"
    "assembly_open:Assembly (lid open)"
    "mw_assembly_view:MakerWorld assembly plate"
